...
if option is not None:
    if option == 2072:
        ...
        st.image("streamlit/images/temp_bad.png", width=150)
    elif option == 2122:
        bar = st.progress(0)
        ...
        st.image("streamlit/images/temp_good.png", width=150)
    elif option == 2172:
        bar = st.progress(0)
        ...
        st.image("streamlit/images/temp_excellent.png", width=150)
